...
#   "generate" "-f" "././Cargo.toml" "-o" "Cargo-generated.nix" "-h" "./IFD/r4mq9danl8znrdldfnsmp85vx5p6prl5-repro-crate2nix-348-crate2nix/crate-hashes.json"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lightgbm" = rec {
        ...
        src = pkgs.fetchgit {
          url = "https://github.com/Ten0/lightgbm-rs.git";
          rev = "ebc5262299d75cc770e21416f9e3ef8204427fba";
          sha256 = "0nr42asw4sg7q7xrkg565ivl1s9b6g75kflzy9hvl3srqrnxf10z";
        };
        authors = [
      ...
      "project1" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./project1; };
        dependencies = [
          {
            name = "lightgbm";
            packageId = "lightgbm";
